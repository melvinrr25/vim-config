...
let s:gold = { "cterm": 198, "gui": "#af87ff" }
...
let s:bold_underline = { "cterm": "NONE", "gui": "bold,underline" }
...
call Highlight("IncSearch", s:white, s:gold, s:bold_underline)
call Highlight("Search", s:white, s:gold, s:bold_underline)

...
hi Constant ctermfg=148 cterm=NONE
" Indentifier -> Parameter in the block - variable Ruby
"hi Identifier ctermfg=148 cterm=NONE "red/pink
...
hi Ignore ctermfg=148 cterm=NONE

hi Todo ctermfg=148 cterm=NONE
...
hi String ctermfg=141 cterm=NONE

hi Boolean ctermfg=148 cterm=NONE

hi Operator ctermfg=148 cterm=NONE

hi Character ctermfg=148 cterm=NONE

hi Tag ctermfg=148 cterm=NONE
